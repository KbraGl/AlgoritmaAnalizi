...
public class Sort {
  ...
  /**
   * Selection sort:
   * - pick smallest #, put it in position 0
   * - pick 2nd smalllest #, put it in position 1
   * ...
   * - pick list.length smallest, put it in position list.length -1
   */ 
  public static void selectionSort(int[] list) {
    ...
    for(int i = 0; i < list.length - 1; i++) {
      ...
      // select the smallest element from unknown area
      // [0..i - 1] are sorted, [i .. list.length - 1] are unknown
      ...
      // take smallest from unknown section,
      // put into the ith position
      int temp = list[i];
